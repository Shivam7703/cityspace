  ...
  return (
    <section className="p-6 sm:p-16 bg-blue1">
      ...
      >
        ...
        <div className="absolute sm:left-1/2 left-2 z-10 -translate-x-1/2 bg-brown2 h-[94%] w-1 top-3" />
        ...
        >
          ...
          <IoMdArrowDropdownCircle className="text-brown2 transition-all duration-300 absolute -bottom-3 -left-[6px] sm:-left-[9px] text-lg sm:text-2xl bg-white rounded-full " />
        ...
        {projectData?.projects?.map((pro) => (
          ...
          >
            ...
            />
            <Link   href={"/projects/detail"} className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-y-7 p-6 text-center text-white bg-gradient-to-t from-black/80 to-black/20">
